...
<div id="content-main"> 
    ...
    <!--Search-container-->
<%Html.RenderPartial("SearchContainer", Model.PagingInfo.SubCurrentCategory); %>
...
<!--content-left-->
   ...
   <!--content-right-->
    <div id="content-right">
      <div class="gen-box">
        <h1><%=Model.PagingInfo.TotalItems.ToString() + " resultado(s) encontrado(s) "%></h1>
        ...
        <%{ %>
          <div class="post-standard">
            <div class="post-inner-lft">
              <div class="post-img"><a href="<%=Url.DetailsUrl(m.Title,m.Category,m.SubCategory,m.AdId)%>"><img src="/FixedSizeImage?image=<%=(ConfigurationManager.AppSettings["DirAddImages"] + m.Image1)%>&width=80&height=50" /></a></div>
        ...
        <%= Html.PageLinks(Model.PagingInfo, Model.Id, Model.PagingInfo.CurrentCategory)%>
